...
public class OrderAggregate {
    ...
    public OrderAggregate(String customerId, String shoppingCartId, BigDecimal totalCost) {
    ...
    public OrderAggregate(CreateOrderCommand command) {
        ...
        LocalDateTime estimatedDeliveryTime =  estimateDeliveryDate();
        AggregateLifecycle.apply(new OrderCreatedEvent(command.getOrderId(), OrderStatus.ORDERED, command.getCustomerId(),
                command.getShoppingCartId(), command.getTotalCost(),placedAt, estimatedDeliveryTime));
    }
